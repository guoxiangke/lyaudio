...
<title>青少年事工(<?php echo $day;?>/30)|公众号：永不止息</title>
	...
	<div class="cover_bg">
		<div class="cover_pic" id="cover_pic">
			...
			<div class="playbg">
				...
				<div class="auther" id="auther"><span id="desc">青少年事工(<?php echo $day;?>/24)</span> <span id="timeremain">00:00</span> </div>
				<div class="progdiv">
					<div class="pgbg">
...
<div id="fmlistbox" class="fmlistbox">
    ...
    <div id="fmlistdiv" class="fmlistdiv">
        ...
        for ($i=$day; $i >= 1; $i--) { 
        	...
        	http://liangyou.u.qiniudn.com/old/d基础课程/001耶稣生平/mavls023.mp3
        	$mp3_link = 'http://liangyou.u.qiniudn.com/old/e本科课程/001青少年事工/mavym'.str_pad($i, 3, "0", STR_PAD_LEFT).'.mp3';
      ?>
			<dl>
				<a href="javascript:void(0)" current='0'  desc="青少年事工-圣洁的渴望(<?php echo $day;?>/30)" src="<?php echo $mp3_link;?>">
