...
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-KPTW8G"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KPTW8G');</script>
<!-- End Google Tag Manager -->
this is a<a href="mailto:dale@xyz.com" oncick="ga('send','event','link','email',this.href)">maitolink</a>
<img src="images/cover.jpg" onmouseover="dataLayer.push({'event','photohover'})">
	<div class="cover_bg">
...
<div id="fmlistbox" class="fmlistbox">
	<div class="header">
        <header>
            <a href="javascript:void(0)" id="all_list" class="list_style" onclick="show_all()">已发布的</a>
            <a href="javascript:void(0)" id="like_list" class="list_style no_select" onclick="show_like()">我喜欢的</a>
