...
// /fm/wx.php?url=http://lywxaudio.yongbuzhixi.com/2016/cw/cw161121.mp3?_upt=6feebb571479807269
$audio_url = $_GET['url'];
?>
<html lang="en">
  <head>
...
<div class="container-fluid">
  ...
  <script type="text/javascript">
    <?php
      $js_radios = array();
      $js_radio['title'] = '在线收听';
      $js_radio['artist'] = '永不止息';
      $js_radio['album'] = '请在浏览器中或safari中打开即可后台收听';
      $js_radio['cover'] = 'img/ybzx320.jpg';
      $js_radio['mp3'] = $audio_url;
      $js_radio['ogg'] = '';
      $js_radios[]= $js_radio;
