...
<html lang="en">
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      document.addEventListener("WeixinJSBridgeReady", function onMenuShareTimeline({
        title: 'test',
        link: 'http://baidu.com',
        imgUrl: 'https://redislabs.com/wp-content/images/redis-logo.png',
        success: function () {
          alert('success');
        },
        cancel: function () {
